...
description: 'Full multi-agent story lifecycle: SM+PM prioritize → BA+PM+UX define → Architect design → Dev build (feature branch) → QA test → Deploy to Railway → Tech Writer document → Create PR'
