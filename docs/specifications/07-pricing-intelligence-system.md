...
specId: 07-pricing-intelligence-system
status: not_started
...
outputArtifacts:
  productBrief: _bmad-output/planning-artifacts/07-pricing-intelligence-system/product-brief.md
  prd: _bmad-output/planning-artifacts/07-pricing-intelligence-system/prd.md
  architecture: _bmad-output/planning-artifacts/07-pricing-intelligence-system/architecture.md
  readinessReport: _bmad-output/planning-artifacts/07-pricing-intelligence-system/implementation-readiness.md
  stories: _bmad-output/planning-artifacts/07-pricing-intelligence-system/epics-and-stories.md
---
