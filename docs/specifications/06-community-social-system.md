...
specId: 06-community-social-system
status: not_started
...
outputArtifacts:
  productBrief: _bmad-output/planning-artifacts/06-community-social-system/product-brief.md
  prd: _bmad-output/planning-artifacts/06-community-social-system/prd.md
  architecture: _bmad-output/planning-artifacts/06-community-social-system/architecture.md
  readinessReport: _bmad-output/planning-artifacts/06-community-social-system/implementation-readiness.md
  stories: _bmad-output/planning-artifacts/06-community-social-system/epics-and-stories.md
---
