...
outputArtifacts:
  ...
  architecture: _bmad-output/planning-artifacts/01-authentication-user-management-system/architecture.md
  readinessReport: _bmad-output/planning-artifacts/01-authentication-user-management-system/implementation-readiness.md
  stories: _bmad-output/planning-artifacts/01-authentication-user-management-system/epics-and-stories.md
---
