...
specId: 03-tcg-catalog-card-database-system
status: completed
...
outputArtifacts:
  productBrief: _bmad-output/planning-artifacts/03-tcg-catalog-card-database-system/product-brief.md
  prd: _bmad-output/planning-artifacts/03-tcg-catalog-card-database-system/prd.md
  architecture: _bmad-output/planning-artifacts/03-tcg-catalog-card-database-system/architecture.md
  readinessReport: _bmad-output/planning-artifacts/03-tcg-catalog-card-database-system/implementation-readiness.md
  stories: _bmad-output/planning-artifacts/03-tcg-catalog-card-database-system/epics-and-stories.md
---
