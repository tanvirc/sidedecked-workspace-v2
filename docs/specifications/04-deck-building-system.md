...
specId: 04-deck-building-system
status: in_progress
...
outputArtifacts:
  productBrief: _bmad-output/planning-artifacts/04-deck-building-system/product-brief.md
  prd: _bmad-output/planning-artifacts/04-deck-building-system/prd.md
  architecture: _bmad-output/planning-artifacts/04-deck-building-system/architecture.md
  readinessReport: _bmad-output/planning-artifacts/04-deck-building-system/implementation-readiness.md
  stories: _bmad-output/planning-artifacts/04-deck-building-system/epics-and-stories.md
---
...
- Required validation entrypoints:
  - node scripts/check-acceptance-criteria.js --id 04-deck-building-system
  - node scripts/check-acceptance-criteria.js --id 04-deck-building-system --next-story
