...
- [x] **T01: Deck browser hero, featured carousel, game tabs, and page restructure** `est:3h`
...
- [x] **T02: Deck grid cards, pagination, stats banner, and mobile browser layout** `est:2h`
...
- [x] **T03: Deck viewer page tabs, visual view, list view, and stats panel** `est:3h`
...
- [x] **T04: Deck builder visual polish, mobile alignment, and cross-page test sweep** `est:2h`
