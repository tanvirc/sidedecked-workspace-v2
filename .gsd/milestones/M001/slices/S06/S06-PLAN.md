...
- [ ] **T01: Commerce wireframes — Cart, Checkout, Order Confirmed** `est:2h`
...
- [ ] **T02: Seller wireframes — Dashboard, List-Card wizard, Upgrade, Payouts, Reputation** `est:2h`
...
- [ ] **T03: User account wireframes — Orders, Addresses, Settings, Wishlist, Reviews, Messages, Returns, Price Alerts** `est:2h`
...
- [ ] **T04: Misc wireframes — Verify Email, Categories, Collections, Community, Info Pages, Seller Storefront, Reset Password, Products** `est:2h`
...
- [ ] **T05: Figma export via MCP** `est:1h`
