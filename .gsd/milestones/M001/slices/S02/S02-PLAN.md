...
- [ ] **T01: Restructure browse page with wireframe layout and shared components** `est:3h`
...
- [ ] **T02: Card grid cells, pagination, trending strip, seller CTA, and mobile browse** `est:3h`
...
- [ ] **T03: Card detail page visual alignment, mobile tabs, and related cards** `est:2h`
...
- [ ] **T04: Search page restructure and cross-page test sweep** `est:2h`
