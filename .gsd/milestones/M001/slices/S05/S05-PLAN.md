...
- [ ] **T01: Build cinematic split-screen auth pages in (auth) route group** `est:2h`
...
- [ ] **T02: Rewrite AuthGateDialog as glassmorphic modal + mobile bottom sheet** `est:1h`
...
- [ ] **T03: Build profile page with hero banner and tabbed layout** `est:2h`
