...
**What doesn't exist yet:** Cart optimizer algorithm/UI, 3-step listing wizard, live OAuth end-to-end test (providers registered but credentials not configured), pixel-perfect wireframe alignment for remaining pages (S07).
