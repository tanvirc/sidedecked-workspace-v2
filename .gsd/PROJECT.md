...
**What doesn't exist yet:** Cart optimizer algorithm/UI, 3-step listing wizard, live OAuth end-to-end test (providers registered but credentials not configured), pixel-perfect wireframe alignment for remaining pages (S07). All 33 wireframes now exist as authoritative alignment targets (S06 complete). Figma export blocked on MCP auth.
